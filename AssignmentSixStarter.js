//name: Jordan Lowrance
//description: Assignment 6
//proposed points: 15, completed each part of the assignment
// 
...
function loadPoints(points,texture) {
    ...
    //Art 1
    points.push(vec4(-5, 4, 1, 1));
    texture.push(vec2(0, 0.5));
    points.push(vec4(-1, 4, 1, 1));
    texture.push(vec2(.35, .5));
    points.push(vec4(-5, 0, 1, 1));
    texture.push(vec2(0, 0));

    points.push(vec4(-1, 4, 1, 1));
    texture.push(vec2(.35, 0.5));
    points.push(vec4(-1, 0, 1, 1));
    texture.push(vec2(.35, 0));
    points.push(vec4(-5, 0, 1, 1));
    texture.push(vec2(0, 0));
